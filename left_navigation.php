            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-circle"></i><a href="index.php?syc=30">List Event</a></li>
                            <li><i class="fa fa-circle"></i><a href="index.php?syc=32">Create Event</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-circle"></i><a href="index.php?syc=101">List Staff</a></li>
                            <li><i class="fa fa-circle"></i><a href="index.php?syc=102">Add Staff</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
